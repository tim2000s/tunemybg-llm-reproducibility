...
In line with the journal's policy on prior posting, both pieces have been posted as preprints, the original article on medRxiv ([DOI 1]) and the commentary on OSF Preprints ([DOI 2]), and on diabettech.com; no updated version will be posted while the manuscripts are under review.
