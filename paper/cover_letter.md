...
In line with the journal's policy on prior posting, both pieces have been posted as preprints, both on Zenodo (original article [DOI 1]; commentary https://doi.org/10.5281/zenodo.22662770), and on diabettech.com; no updated version will be posted while the manuscripts are under review.
