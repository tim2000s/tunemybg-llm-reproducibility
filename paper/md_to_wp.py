...
for a,b in [ ("TuneMyBG is an Android app", "[TuneMyBG](https://play.google.com/store/apps/details?id=com.adamkowalczyk.tunemybg) is an Android app"),
 ...
 ("posted as preprints [preprint links]", "posted as preprints [here](STUDY-PREPRINT-URL) and [here](COMMENTARY-PREPRINT-URL), with archived copies on [medRxiv](MEDRXIV-URL) and [OSF](OSF-URL)")]:
